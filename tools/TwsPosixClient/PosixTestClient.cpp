...
void PosixTestClient::reqCurrentTime()
{
	...
	m_pClient->reqMktData(tickId++, contract, "100,101,104,105,106,107,165,221,225,233,236,258,293,294,295,318", false);
...
void PosixTestClient::tickPrice( TickerId tickerId, TickType field, double price, int canAutoExecute) {
	printf( "id=%i, %f  canAutoExecute=%d",tickerId, price, canAutoExecute);
