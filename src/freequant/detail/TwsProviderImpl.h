#ifndef FQ_DETAIL_TWSPROVIDERIMPL_H
#define FQ_DETAIL_TWSPROVIDERIMPL_H
...
class TwsProviderImpl : private EWrapper {
public:
    TwsProviderImpl(const std::string& connection, FreeQuant::TradeProvider::Callback *callback) {
        _params = FreeQuant::parseParamsFromString(connection);
...
//    }
    ...
    void connect() {
        ...
        if (ret) {
            ...
            _thread.reset(new boost::thread(&TwsProviderImpl::exec, this));
        }
    }
...
private:
    ...
    FreeQuant::TradeProvider::Params _params;
    std::unique_ptr<EPosixClientSocket> _socket;
...
#endif // FQ_DETAIL_TWSPROVIDERIMPL_H
