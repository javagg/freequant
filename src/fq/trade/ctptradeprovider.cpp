...
#include <fq/strategy/Position.h>
...
void CtpTradeProvider::OnRspQryInvestorPosition(CThostFtdcInvestorPositionField *position, CThostFtdcRspInfoField *rspInfo, int requestID, bool last) {
    FreeQuant::Strategy::Position pos;
...
void CtpTradeProvider::sendOrder(FreeQuant::Strategy::Order& o) {
...
void CtpTradeProvider::cancelOrder(FreeQuant::Strategy::Order& o) {
...
void CtpTradeProvider::replaceOrder(FreeQuant::Strategy::Order& o) {
    CThostFtdcInputOrderActionField req = {};
    _appId.copy(req.BrokerID, _appId.size());
    _userId.copy(req.InvestorID, _userId.size());
